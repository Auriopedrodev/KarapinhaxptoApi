...
import '../FormAddProfissionais/FormAddProfissionais.css';
...
export default function FormAddProfissionais() {
    ...
    const handleSubmit = async () => {
        try {
            ...
            // Preparar payload JSON para /api/ProfissionalHorario
            const horarioData = {
                ProfissionalId: response1.data.id, // Assumindo que a resposta contém um id
                Horario: formData.horario
            };

            // Chamada da API para /api/ProfissionalHorario
            const response2 = await axios.post('https://localhost:7262/api/ProfissionalHorario', horarioData);
            console.log('Response from /api/ProfissionalHorario:', response2.data);
                ...
                <Modal.Body>
                    <form className="row g-3">
                        ...
                        <div className="col-md-6">
                            ...
                            <input type="time" className="form-control" id="horario" onChange={handleChange} />
                        </div>
